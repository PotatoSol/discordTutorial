...
console.log(token);
AWS.config.update({//i hope this works
  region: JSON.parse(token)[3].toString(), //convert this to string somehow
  accesKeyId: JSON.parse(token)[4].toString(),
  secretAccesKey: JSON.parse(token)[5].toString()
})
